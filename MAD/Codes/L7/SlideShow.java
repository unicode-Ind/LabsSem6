...
public class SlideShow extends MIDlet implements CommandListener {
	...
	public SlideShow() {
		...
		try {
			image1 = Image.createImage("/SlideS1.png");
			image2 = Image.createImage("/SlideS2.jpg");
			image3 = Image.createImage("/SlideS3.png");
	...
	public void startApp() {
		Thread runner = new Thread(new ThreadRunner(display, slide1, slide2, slide3)); runner.start();
	}
...
class ThreadRunner implements Runnable {
	...
	public void run() {
		while (true) {
			c++;
			if (c == 1)
				display.setCurrent(slide1); else if (c == 2)
...
// 			imageitem2 = new ImageItem(null, image2, ImageItem.LAYOUT_CENTER, "image2");
// 			imageitem3 = new ImageItem(null, image3, ImageItem.LAYOUT_CENTER, "image3");
// 		} catch (Exception ex) { } Exit = new Command("Exit", Command.EXIT, 1);
// 		slide1 = new Form("Slide1");
// 		slide1.append(imageitem1);
// 		slide1.addCommand(Exit);
...
// 		runner.start();
// 	} public void pauseApp() { } public void destroyApp(boolean unconditional) { } public void commandAction(Command command, Displayable displayable) {
// 		if (displayable == slide1) {
// 			if (command == Exit) {
// 				notifyDestroyed();
// 			} else if (displayable == slide2) {
